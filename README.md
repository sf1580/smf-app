...
![exist-db CI](https://github.com/sf1580/my-app/workflows/exist-db%20CI/badge.svg)
...
1.  Download  the `my-app-1.0.0.xar` file from GitHub [releases](https://github.com/sf1580/my-app/releases) page.
...
GPL-3.0 © [sf1580](http://exist-db.org)
...
[release-url]: https://github.com/sf1580/my-app/releases/latest
